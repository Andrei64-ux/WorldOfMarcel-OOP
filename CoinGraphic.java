...
public class CoinGraphic {
    ...
    public CoinGraphic(int x, int y) {
        loadImage();
    ...
    public void loadImage() {
        try {
            image = ImageIO.read(new File("C:\\Users\\user\\OneDrive - Universitatea Politehnica Bucuresti\\Desktop\\TemaPOO\\src\\image\\coins.jpg"));
