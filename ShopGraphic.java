...
public class ShopGraphic {
    ...
    public ShopGraphic(int x, int y) {
        loadImage();
    ...
    public void loadImage() {
        try {
            image = ImageIO.read(new File("C:\\Users\\user\\OneDrive - Universitatea Politehnica Bucuresti\\Desktop\\TemaPOO\\src\\image\\shop.gif"));
